    ...
    articles = [
            {
                ...
                'star_t': '需要判断到底应该加固机翼、机尾，还是发动机和驾驶舱这些看似中弹少的部位。',
                'star_a': '统计学家沃尔德指出样本只包含成功返航的飞机，建议把装甲加到数据缺失、真正致命的部位。',
            ...
            },
            {
                ...
                'content': '1970 年 4 月，阿波罗 13 号在飞往月球的途中，服务舱的一个氧气罐突然爆炸。飞船失去了大部分电力、氧气和推进能力，三名宇航员的生命危在旦夕。地面控制中心和宇航员面临一个几乎不可能完成的任务：在登月已经不可能的情况下，把宇航员安全带回地球。此时，飞船上的指令舱电力几乎耗尽，舱内二氧化碳浓度迅速上升，可供呼吸的空气越来越少。NASA 地面团队必须利用飞船上有限的物资，在极短时间内设计出一套应急方案。工程师们临时用胶带、塑料袋和手册上的零件，拼凑出一个二氧化碳过滤装置；导航团队精确计算了数次轨道修正，确保飞船以正确的角度再入大气层；同时，宇航员被指令进入登月舱，把它当作一艘临时救生艇。在接下来的四天里，数千名工程师、飞行员和科学家几乎不眠不休地协作。最终，阿波罗 13 号指令舱在南太平洋安全溅落，三名宇航员全部生还。这次任务虽然未能登月，却被视为航天史上最伟大的救援行动之一。它证明了一个深刻的道理：真正的能力不仅在于按计划完成任务，更在于当计划彻底崩塌时，依然能够保持冷静、整合资源并找到出路。',
                'difficulty': 2,
                'star_s': '1970 年 4 月，阿波罗 13 号服务舱氧气罐爆炸，三名宇航员面临生命危险。',
                'star_t': 'NASA 必须在登月已不可能的情况下，把宇航员安全带回地球。',
                'star_a': '地面团队临时制作二氧化碳过滤装置，精确计算轨道修正，并把登月舱当作救生艇。',
                'star_r': '三名宇航员全部安全返回，这次任务成为航天史上最伟大的救援行动之一。',
                'keywords': '阿波罗13号, 危机管理, 即兴创新, 团队协作'
            },
            {
                'method': 'STAR',
                'title': '微信的诞生：一个被内部质疑的项目如何突围',
                'content': '2010 年，腾讯已经拥有手机 QQ，但张小龙和他的团队意识到，移动互联网时代需要一种更轻、更快、更贴近手机体验的沟通方式。他们开始立项微信，却在公司内部引发了大量质疑：手机 QQ 已经占据市场，用户为什么还需要另一款类似产品？即使做出来，会不会反而侵蚀 QQ 的用户？张小龙坚持认为，QQ 的架构和功能是为 PC 时代设计的，而手机原生应用需要完全不同的产品哲学。他的任务是：在巨头林立、用户习惯尚未形成的窗口期，打造一款能够重新定义移动社交的产品。团队选择了一条极简路径，从免费即时消息和语音对讲切入，刻意保持界面干净，避免功能堆砌。随后，他们逐步推出朋友圈、公众号、微信支付和小程序，每一次扩展都围绕"连接"这个核心逻辑展开。微信上线后增长迅速，短短一年多时间用户破亿，并在随后十年成长为月活超过 13 亿的超级应用。它不仅改变了人们的沟通方式，也重塑了内容创作、商业交易和公共讨论的整个生态。微信的成功证明：真正的创新往往不是复制已有的成功，而是敢于在组织内部质疑主流叙事，为尚未被满足的需求开辟新的产品形态。',
                'difficulty': 2,
                'star_s': '2010 年，腾讯内部已有手机 QQ，张小龙团队提出做微信时遭到大量质疑。',
                'star_t': '团队需要在移动社交窗口期，打造一款超越 QQ、符合手机原生体验的产品。',
            ...
            },
            {
                ...
                'content': '2020 年初，新冠疫情突然暴发，公众面对的是大量未知、矛盾的信息和迅速蔓延的恐慌。在这种情况下，医学专家不仅要提供科学建议，还要在信息碎片化和情绪化的环境中建立公众信任。张文宏作为一名感染科医生，承担了向公众解释疫情的角色。他的任务是：在不确定性极高的情况下，把复杂的医学信息翻译成普通人能理解和执行的建议，同时避免制造新的恐慌。张文宏选择了一种直接、坦诚且有温度的表达方式。他用通俗语言解释病毒传播链，明确告诉人们"少出门、戴口罩、勤洗手"为什么有效；在一线压力最大的时候，他说"党员先上"，用具体行动承担责任；面对未知，他不回避，而是清楚说明科学判断的依据和局限。他的表达里没有高高在上的说教，也没有模棱两可的安抚。几个月后，张文宏成为公众最信任的医学专家之一，他的沟通方式也被视为危机传播的典型案例。这个故事说明：在公共危机中，最有效的表达不是最华丽的，而是最诚实、最具体、最能让人采取行动的。',
                'difficulty': 2,
                'star_s': '2020 年初新冠疫情暴发，公众信息混乱、恐慌蔓延，医学专家需要在不确定中建立信任。',
                'star_t': '张文宏需要把复杂的医学信息翻译成普通人可执行的建议，同时避免制造恐慌。',
            ...
            },
            {
                ...
                'content': '2020 年，瑞幸咖啡自曝财务造假 22 亿元人民币，公司股价一夜暴跌 80%，面临退市、诉讼和信任崩塌的多重危机。这家曾以激进补贴和快速扩张著称的咖啡品牌，几乎在一夜之间成为中概股丑闻的代名词。新管理层上任后，面临一个艰巨任务：如何在废墟上重建一个可持续的商业模式，同时向资本市场、供应商和消费者证明公司还有继续经营的价值。他们没有选择继续掩盖或逃避，而是公开承认错误，更换核心团队，启动与监管机构和投资者的和解，并迅速调整战略。具体行动上，瑞幸关闭了长期亏损的门店，优化了供应链，减少了补贴依赖，同时大力发展自提和外卖数字化运营，推出爆款产品如生椰拿铁。两年后，瑞幸实现了扭亏为盈，门店数量反超星巴克中国，成为中国咖啡市场的重要力量。它的反转并非因为奇迹，而是因为敢于直面问题、砍掉虚假增长、回归商业本质。瑞幸的案例提醒我们：危机本身并不可怕，可怕的是用错误的方式延续错误。',
                'difficulty': 2,
                'star_s': '2020 年，瑞幸咖啡自曝财务造假，股价暴跌，面临退市、诉讼和信任崩塌。',
                'star_t': '新管理层需要重建可持续商业模式，并向市场证明公司仍有经营价值。',
